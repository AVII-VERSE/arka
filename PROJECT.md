...
| M5 | R4: Active Response Container & Service | Implement `agent/arka_agent/active_response.py`, `backend/app/services/active_response_service.py`, `backend/app/api/v1/endpoints/active_response.py` | M1 | IN_PROGRESS |
| M6 | R5: Vulnerability & CVE Engine | Implement `backend/app/services/vulnerability_engine.py`, `backend/app/api/v1/endpoints/vulnerabilities.py`, package correlation | M1, M4 | IN_PROGRESS |
